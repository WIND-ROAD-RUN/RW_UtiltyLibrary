...
//namespace rw {
//    namespace tdp {
//        using TransactionRequestType = oso::StorageType;
//
...
//        };
//
//        template <class TransactionClass, TransactionRequestType requestType= TransactionRequestType::Xml>
...
//        template <class TransactionClass>
//        inline 
//        TransactionRequest<TransactionClass, TransactionRequestType::Xml>::
//        TransactionRequest()
//        :_organizeStructure(TransactionRequestType::Xml)
//        {
//        }
//
//        template <class TransactionClass>
//        inline std::string 
//        TransactionRequest<TransactionClass, TransactionRequestType::Xml>::getRequest
